...
│ Аватар       │ Таблица данных       │
├────────────────────────────────────┤
│ Введите суперсилу для персонажа     │
├────────────────────┬───────────────┤
│ Повышает конверсию │ [Продажи]      │
│ в продажу          │               │
├────────────────────┼───────────────┤
│ Повышает конверсию │ [Маркетинг]    │
│ прогрева           │               │
├────────────────────┼───────────────┤
│ Повышенное кол-во  │ [Энергичность] │
│ энергии изначально │               │
├────────────────────┼───────────────┤
│ Повышает конверсию │ [Реклама]      │
│ из рекламы         │               │
├────────────────────────────────────┤
│ [Готово, дальше]                    │
└────────────────────────────────────┘
...
```text
Ты выбрал суперспособность Маркетинг.
Помимо повышенной конверсии прогревов она дает зрение маркетолога.
Вы видите оценку для всех инструментов прогрева.
```
...
2. информационная суперспособность или особое преимущество.
...
├──────────────────────────────────────┤
│ Серый текст:                          │
│ {Имя}, у нас в этом месяце            │
│ все уже хорошо...                     │
│ Давай выделим 100 000 рублей          │
│ на твое дело...                       │
├──────────────────────────────────────┤
│ [Далее]                               │
└──────────────────────────────────────┘
...
├──────────────────────────────────────┤
│ Серый блок правил:                    │
│ Наверху всегда показаны 3 параметра.  │
│ День - сколько дней прошло.           │
│ Банк - остаток стартовых денег.        │
│ Выручка от продаж сюда не входит.      │
│ Энергия - если закончится,             │
│ вы выгорели и игра закончится.         │
│ Цель - сделать достаточно продаж,      │
│ чтобы купить мечту.                    │
│ Игра заканчивается если...             │
├──────────────────────────────────────┤
│ [Правила ясны!]                       │
...
│ День       │ Банк       │ Энергия    │
├──────────────────────────────────────┤
│ Желтая картинка: персонаж со спутником│
├──────────────────────────────────────┤
│ Серый текст:                          │
│ Я сейчас поеду по делам.              │
│ А ты пока подумай, что ты хочешь       │
│ продавать и что хочешь купить         │
│ с продаж.                             │
├──────────────────────────────────────┤
│ [Хорошо]                              │
└──────────────────────────────────────┘
...
│ День       │ Банк       │ Энергия    │
├──────────────────────────────────────┤
│ Желтая картинка: тетрадь и руки       │
├──────────────────────────────────────┤
...
│ День       │ Банк       │ Энергия    │
├──────────────────────────────────────┤
│ Желтая картинка: крупный план заката  │
├──────────────────────────────────────┤
│ Серый текст:                          │
│ Прошел 1 день.                        │
│ {Имя} придумала, что будет продавать  │
│ {продукт} за {цена}.                  │
│ Когда все получится, {имя} хочет      │
│ купить: {мечты}.                      │
│ Для этого цель: {продаж} продаж       │
│ и {выручка} рублей.                   │
├──────────────────────────────────────┤
│ [Цель ясна]                           │
└──────────────────────────────────────┘
...
├──────────────────────────────────────┤
│ Серый текст:                          │
│ {Имя} начинает цикл запуска.          │
│ Сейчас вы увидите меню рефлексии.     │
│ Оно будет появляться после каждой     │
│ волны действий.                       │
│                                      │
│ Каждая волна включает:                │
│ рефлексию, подготовку, активный этап, │
│ итоги попытки.                        │
│                                      │
│ "Подготовиться" - действия подготовки.│
│ "Посоветоваться" - разобрать прошлое  │
│ или наметить будущее.                 │
│ "Восстановить энергию" - отдых.       │
│ "Действовать" - запуск волны продаж.  │
├──────────────────────────────────────┤
│ [Понятно!]                            │
└──────────────────────────────────────┘
```
...
│ ваших действий.                       │
│                                      │
│ Вы будете видеть, какие результаты    │
│ дают реклама, прогрев и продажи.      │
│ В зависимости от выбранных            │
│ инструментов, возможно, нужно будет   │
│ отвечать на сообщения или звонки.     │
│                                      │
│ Старайтесь успевать. Это тратит       │
│ энергию. Если энергия закончится,     │
│ необработанные обращения будут        │
│ потеряны.                             │
├──────────────────────────────────────┤
│ [Понятно!]                            │
└──────────────────────────────────────┘
