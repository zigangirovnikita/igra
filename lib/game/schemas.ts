...
export const commandRequestSchema = z.discriminatedUnion('type', [
  ...
  z.object({ ...base, type: z.literal('choose_intent'), payload: z.object({ intent: z.string() }) }),
  z.object({ ...base, type: z.literal('choose_action_group'), payload: z.object({ group: z.string() }) }),
  ...
  z.object({ ...base, type: z.literal('resolve_pending_decision'), payload: z.object({ cohortId: z.string(), action: z.enum(['process', 'defer', 'ignore']), amount: z.number().optional() }) }),
