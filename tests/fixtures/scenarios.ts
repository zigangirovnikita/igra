...
export const scenarios: ScenarioFixture[] = [
  scenario('strong_reels_bot_calls', { ...baseSetup, averageReelViews: 7_000, productPrice: 100_000 }, ['demand_pilot_offer', 'product_pilot', 'guide_specialist', 'ai_bot_specialist'], callsRoute, ['reels_7d', 'reels_7d', 'manual_followup']),
  ...
  scenario('weighted_typical_user', { ...baseSetup, productType: 'mentorship', productPrice: 220_000, averageReelViews: 15_000 }, ['demand_interviews', 'product_self', 'simple_bot_specialist'], { ...callsRoute, processing: 'simple_bot', followup: 'none' }, ['reels_7d']),
  ...
  scenario('expensive_call', { ...baseSetup, productPrice: 220_000, productType: 'mentorship' }, ['demand_pilot_offer', 'product_pilot', 'video_specialist'], callsRoute, ['reels_7d']),
